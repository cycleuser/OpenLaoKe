...
def run_config_wizard(config: AppConfig | None = None) -> AppConfig:
    ...
    while True:
        ...
        providers = [
            ...
            ("5", "Anthropic (Claude)", "anthropic", "cloud"),
            ("6", "OpenAI", "openai", "cloud"),
            ...
            ("21", "LM Studio (Local)", "lm_studio", lm_status),
            ("22", "OpenAI-Compatible / Local Server", "openai_compatible", "custom"),
