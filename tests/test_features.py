...
class TestBashClassifier:
    ...
    def test_git_push_dangerous(self):
        assert (
            classify_bash_command("git push origin main").safety_level
            == CommandSafetyLevel.DANGEROUS
        )

    def test_npm_install_dangerous(self):
        assert (
            classify_bash_command("npm install express").safety_level
            == CommandSafetyLevel.DANGEROUS
        )

    def test_pip_install_dangerous(self):
        assert (
            classify_bash_command("pip install requests").safety_level
            == CommandSafetyLevel.DANGEROUS
        )
    ...
    def test_path_traversal_dangerous(self):
        assert (
            classify_bash_command("cat ../../../etc/passwd").safety_level
            == CommandSafetyLevel.DANGEROUS
        )
