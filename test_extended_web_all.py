...
async def test_deepseek(cookie: str):
    ...
    try:
        ...
        if content:
            console.print(f"[green]✓ DeepSeek works![/green]")
...
async def test_qwen(cookie: str):
    ...
    try:
        ...
        content = response.get("content", "")
        if content:
            console.print(f"[green]✓ Qwen works![/green]")
            console.print(f"  Response: {content[:100]}...")
            return True
        else:
            console.print(f"[yellow]⚠ Empty response[/yellow]")
...
async def test_glm(cookie: str):
    ...
    try:
        ...
        content = response.get("content", "")
        if content:
            console.print(f"[green]✓ GLM works![/green]")
            console.print(f"  Response: {content[:100]}...")
            return True
        else:
            console.print(f"[yellow]⚠ Empty response[/yellow]")
